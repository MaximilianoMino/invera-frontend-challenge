    ...
    <Popover>
      <PopoverTrigger asChild>
        <Button
          type='button'
          variant='outline'
          className='flex gap-1 bg-[#212121] rounded-e-none rounded-s-lg border-0 px-3 focus:z-10'
          disabled={disabled}
        >
...
const FlagComponent = ({ country, countryName }: RPNInput.FlagProps) => {
  ...
  return (
    <span className='flex h-4 p-0 w-6 overflow-hidden rounded-sm [&_svg]:size-full'>
